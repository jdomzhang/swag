...
4. In order to serve these files, you can utilize one of our supported plugins. For go's core library, check out [net/http](https://github.com/jdomzhang/http-swagger).
...
- [gin](http://github.com/jdomzhang/gin-swagger)
- [echo](http://github.com/jdomzhang/echo-swagger)
- [buffalo](https://github.com/jdomzhang/buffalo-swagger)
- [net/http](https://github.com/jdomzhang/http-swagger)
...
```go
import "github.com/jdomzhang/gin-swagger" // gin-swagger middleware
import "github.com/jdomzhang/gin-swagger/swaggerFiles" // swagger embed files
```
